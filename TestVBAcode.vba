...
Private Function Solve() As Double
	...
	Do Until err < 0.000001
		...
		Else
			...
			End If
		If xm < xr Then
			If fxl * fxm < 0 and fxu * fxr < 0 Then
				xl = xrNew
			ElseIf fxl * fxm < 0 and fxu * fxm < 0 Then
				xl = xm
				xu = xrNew
		...
		End If
		Else
			If fxl * fxr < 0 and fxu * fxm < 0 Then
				xl = xr
			ElseIf fxl * fxr < 0 and fxu * fxr < 0 Then
				xl = xm
				xu = xr
			ElseIf 0 < fxl * fxr and 0 < fxu * fxr Then
				xl = xr
			ElseIf fxm * fxr < 0 Then
				xl = xrNew
				xu = xm
